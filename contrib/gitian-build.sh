...
VERSION=
commit=false
url=https://github.com/titancoin-project/titancoin
proc=2
mem=2000
lxc=true
...
Run this script from the directory containing the titancoin, gitian-builder, gitian.sigs.ltc, and titancoin-detached-sigs.
...
-u|--url	Specify the URL of the repository. Default is https://github.com/titancoin-project/titancoin
...
then
	...
	then
	    ...
	    ./bin/gsign -p $signProg --signer $SIGNER --release ${VERSION}-linux --destination ../gitian.sigs.ltc/ ../titancoin/contrib/gitian-descriptors/gitian-linux.yml
	...
	then
	    ...
	    ./bin/gsign -p $signProg --signer $SIGNER --release ${VERSION}-win-unsigned --destination ../gitian.sigs.ltc/ ../titancoin/contrib/gitian-descriptors/gitian-win.yml
	...
	then
	    ...
	    ./bin/gsign -p $signProg --signer $SIGNER --release ${VERSION}-osx-unsigned --destination ../gitian.sigs.ltc/ ../titancoin/contrib/gitian-descriptors/gitian-osx.yml
...
then
	...
	then
	    ...
	    ./bin/gsign -p $signProg --signer $SIGNER --release ${VERSION}-win-signed --destination ../gitian.sigs.ltc/ ../titancoin/contrib/gitian-descriptors/gitian-win-signer.yml
	...
	then
	    ...
	    ./bin/gsign -p $signProg --signer $SIGNER --release ${VERSION}-osx-signed --destination ../gitian.sigs.ltc/ ../titancoin/contrib/gitian-descriptors/gitian-osx-signer.yml
