Titancoin Core version *0.15.1* is now available from:

  <https://download.titancoin.org/titancoin-0.15.1/>
...
A number of changes to the way Titancoin Core deals with peer connections and invalid blocks
...
The minimum relay fee `-minrelayfee` has been lowered to 0.01 robots per kB (0.00001 TIC). This is to prepare for dropping the minimum transaction fee to 0.1 robots per kB (0.0001 TIC) in the next release.
